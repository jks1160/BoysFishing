	...
	<nav class="navbar navbar-expand-lg navbar-light "
		...
		<div class="container-fluid">
			<a class="navbar-brand" href="/fishing/"> <span
				style="color: white; font-size:25px ; vertical-align:middle;">SOMEFISH</span> <svg
					xmlns="http://www.w3.org/2000/svg" width="36" height="36"
					fill="currentColor" class="bi bi-image-alt" style="color: white; vertical-align: middle;"
					viewBox="0 0 16 16">
			...
			<div class="d-flex" id="menu">
				...
				<div class="collapse navbar-collapse" id="navbarSupportedContent">
					...
					<a class="navbar-brand" href="#"> <svg	xmlns="http://www.w3.org/2000/svg" width="36" height="36"
							fill="currentColor" class="bi bi-bell" style="color: white; " viewBox="0 0 16 16">
					  <path
