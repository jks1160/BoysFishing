...
<html>
	...
	<h2>${dto.u_usernickname} 님의 배 정보</h2>
	<div class="rounded float-start">
	<c:choose> 
		<c:when test="${dto.ui_name eq null}">
		<img src="resources/defaultprofile.png" id="profileImg" class="rounded" alt="기본 이미지" style="width: 200px;">
		</c:when>
		<c:otherwise>
		<img src="/photo/${dto.ui_name}" id="profileImg" class="rounded" alt="배 이미지" style="width: 200px;">
		</c:otherwise>
	</c:choose>
